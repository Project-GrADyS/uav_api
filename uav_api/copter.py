...
Also, ignores heartbeats not from our target system"""
    ...
    async def send_location_to_gradys_gs(self, api_port, gradys_gs_address):
        """Asynchronously send location data to Gradys Ground Station."""
        async def send_post_req(path, data):
            result = None
        ...
        while True:
            try:
                ...
                location = self.mav.location(relative_alt=True)
                data = {
                    "id": self.sysid,
